...
ALTER TABLE public.goals ADD CONSTRAINT goals_parent_fkey FOREIGN KEY (parent) REFERENCES public.goals(id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE public.tasks ADD CONSTRAINT tasks_goal_fkey FOREIGN KEY (goal) REFERENCES public.goals(id) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE public.tasks ALTER COLUMN performance_history SET DEFAULT '[]'::jsonb;
